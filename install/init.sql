...
CREATE TABLE IF NOT EXISTS `__PREFIXactualiteelements` (
...
CREATE TABLE IF NOT EXISTS `__PREFIXactualites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(150) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `__PREFIXbandcamps` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(150) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `__PREFIXboutiquecats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(150) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `__PREFIXboutiqueproduits` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(150) NOT NULL,
  ...
  `desccourt` varchar(255) DEFAULT NULL,
  `desclong` text,
  `boutiquecat_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `__PREFIXboutiques` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(150) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `__PREFIXcatadmins` (
...
CREATE TABLE IF NOT EXISTS `__PREFIXevenementelements` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `date` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `__PREFIXevenements` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(150) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `__PREFIXgaleriesphotoelements` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(150) NOT NULL,
  `selection` varchar(100) DEFAULT NULL,
  `width` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `__PREFIXgaleriesphotos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(150) NOT NULL,
  `contenu` text,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `__PREFIXhtmls` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(150) NOT NULL,
...
INSERT INTO `__PREFIXcatadmins` (`id`, `nom`, `controller`, `action`, `parent`, `ordre`) VALUES
(0, 'Catégories Mère', '', '', 0, 0),
(1, 'Rubriques Admin', 'Catadmins', 'index', 0, 90),
(2, 'Menu', 'menugroupes', 'list', 0, 2),
(3, 'Utilisateurs', 'Users', 'list', 0, 10),
(4, 'Rubriques', 'rubriques', 'list', 0, 0),
(5, 'Contenus', 'contenutypes', 'list', 0, 4),
(6, 'Graphisme', 'graphelements', 'edit', 0, 3),
(7, 'Paramètre', 'parametres', 'edit', 0, 8),
(8, 'Zone', 'zoneelements', 'edit', 6, 1),
(9, 'Général', 'graphelements', 'edit', 6, 0),
(10, 'Paramètre', 'parametres', 'edit', 7, 0),
(11, 'Langues', 'Languages', 'list', 7, 1),
(12, 'Css', 'styles', 'edit', 7, 3) ;

UPDATE  `__PREFIXcatadmins` SET  `id` =  '0' WHERE  `id` =13 ;

/*
--
-- choix des plugins installés
--
*/
...
/*
--
-- Mise en page par défault + mep cont ?
--
*/
...
/*
--
-- Rubrique - Voir date en auto
--
*/

INSERT INTO `__PREFIXrubriques` (`id`, `nom`, `url`, `parent`, `metatitle`, `metadescription`, `metakeyword`, `created`, `modified`, `contenutype_id`, `contenupage_id`) VALUES
(0, 'Catégories Mère','','','', '', 0, '', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 1),
(1, 'Accueil','','','', '', 0, 'My Company - Everything and Nothing', 'My Company, Nous faisons tous et principalement rien', 'My Company,Everything,Nothing', '0000-00-00 00:00:00', '2012-07-06 10:53:26', 1, 1) ;

UPDATE  `__PREFIXrubriques` SET  `id` =  '0' WHERE  `id` =2 ;
