...
INSERT INTO `__PREFIXdiaporamas` (`id`, `nom`, `selection`, `width`, `height`, `url`, `contenu`, `speed`, `pause`, `scroll`, `metatitle`, `metadescription`) VALUES
  (1, 'Diapo entete', NULL, 1000, 320, '', '', 1000, 5000, 'horizontal', '', '') ;
...
INSERT INTO `__PREFIXformelements` (`id`, `nom`, `type`, `content`, `position`, `label`, `obligatoire`, `alignement`, `width`, `form_id`) VALUES
  (1, 'Nom', 'text', '', NULL, 1, 1, '', 250, 1),
  (2, 'E-mail', 'text', '', NULL, 1, 1, '', 250, 1),
  (3, 'Message', 'textarea', '', NULL, 1, 1, 'V', 450, 1) ;

INSERT INTO `__PREFIXforms` (`id`, `nom`, `sendfrom`, `sendto`, `metatitle`, `metadescription`) VALUES
  (1, 'Contact', 'contact@thomas-abadie.com', 'contact@thomas-abadie.com', '', '') ;

INSERT INTO `__PREFIXgraphelements` (`id`, `nom`, `active`, `width`, `height`, `fondcolor`, `fondimg`, `fondimgfolder`, `fondimgpos`, `fondimgrepeat`, `border`, `borderradius`, `margin`, `padding`, `float`, `textsize`, `textcolor`, `textalign`, `textgras`, `textfont`) VALUES
  (1, 'fond', 1, NULL, NULL, '#555555', 'standard/defaut_fond.jpg', '', '', 'repeat-x', NULL, NULL, '0px 0px 0px 0px ', '0px 0px 0px 0px ', NULL, NULL, NULL, NULL, NULL, NULL),
  (2, 'contenu', 1, '1000', NULL, '#ffffff', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (3, 'tete', 1, '1000', '358', '', 'standard/defaut_tete.jpg', '', '', '', NULL, NULL, '0px 0px 0px 0px ', '0px 0px 0px 0px ', NULL, NULL, NULL, NULL, NULL, NULL),
  ...
  (8, 'menu_Général', 1, '200', '28', '', 'standard/defaut_fondmenu.jpg', '', '', 'repeat-x', '0px #ffffff solid', '0px 0px 0px 0px ', '0px 0px 0px 0px ', '12px 0px 0px 0px ', 'left', '12pt', '#ffffff', 'center', 'bold', 'Verdana'),
  ...
  (10, 'ze_1', 1, '1000', '40', '', 'standard/defaut_fondmenu.jpg', '', '', 'repeat-x', '0px  solid', '0px 0px 0px 0px ', '0px 0px 0px 0px ', '0px 0px 0px 0px ', 'left', '', '', 'left', 'normal', NULL),
  (11, 're_1', 1, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (12, 're_2', 1, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (13, 'ze_2', 1, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (14, 're_3', 1, '500px', '', '', '', '', '', '', '0px #000000 solid', '0px 0px 0px 0px ', '0px 0px 0px 250px ', '0px 0px 0px 0px ', '', '', '', 'left', 'normal', NULL),
  (15, 'ze_fo1', 1, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL) ;
...
INSERT INTO `__PREFIXi18n` (`id`, `locale`, `model`, `foreign_key`, `field`, `content`) VALUES
  ...
  (12, 'fre', 'Pageslibre', 1, 'contenu', '<h1>\r\n Bienvenue !</h1>\r\n<p>\r\n Merci d&#39;utiliser Link To The Web</p>\r\n<p>\r\n  Vous pouvez vous connecter &agrave; la console d&#39;administration<a href="admin666"><strong> ici</strong></a></p>\r\n<p>\r\n  Par d&eacute;faut votre login est votre <strong>adresse e-mail</strong> et le mot de passe : <strong>123123</strong><br />\r\n  <em>Pensez &agrave; le modifier d&egrave;s votre premi&egrave;re connection</em></p>\r\n<p>\r\n &nbsp;</p>\r\n<p>\r\n Pour plus de s&eacute;curit&eacute;s, nous vous conseillons de <strong>supprimer le dossier install</strong>.</p>\r\n<p>\r\n  &nbsp;</p>\r\n<p>\r\n N&#39;h&eacute;sitez pas &agrave; nous faire des retour sur contact@thomas-abadie.net</p>\r\n<p>\r\n  &nbsp;</p>\r\n<p>\r\n &nbsp;</p>\r\n<p>\r\n &nbsp;</p>\r\n<p>\r\n &nbsp;</p>\r\n'),
  (13, 'fre', 'Diaporama', 1, 'contenu', ''),
  (14, 'fre', 'Pageslibre', 2, 'nom', 'Qui sommes nous'),
  (15, 'fre', 'Pageslibre', 2, 'contenu', '<p>\r\n  Description &nbsp;...</p>\r\n'),
  (16, 'fre', 'Rubrique', 2, 'nom', 'Qui sommes nous ?'),
  (17, 'fre', 'Rubrique', 2, 'url', ''),
  (18, 'fre', 'Rubrique', 2, 'metatitle', ''),
  (19, 'fre', 'Rubrique', 2, 'metadescription', ''),
  (20, 'fre', 'Rubrique', 2, 'metakeyword', ''),
  (21, 'fre', 'Rubrique', 3, 'nom', 'Contact'),
  (22, 'fre', 'Rubrique', 3, 'url', ''),
  (23, 'fre', 'Rubrique', 3, 'metatitle', ''),
  (24, 'fre', 'Rubrique', 3, 'metadescription', ''),
  (25, 'fre', 'Rubrique', 3, 'metakeyword', ''),
  (26, 'fre', 'Form', 1, 'nom', 'Contact'),
  (27, 'fre', 'Formelement', 1, 'nom', 'Nom'),
  (28, 'fre', 'Formelement', 1, 'content', ''),
  (29, 'fre', 'Formelement', 2, 'nom', 'E-mail'),
  (30, 'fre', 'Formelement', 2, 'content', ''),
  (31, 'fre', 'Formelement', 3, 'nom', 'Message'),
  (32, 'fre', 'Formelement', 3, 'content', '') ;
...
INSERT INTO `__PREFIXpageslibres` (`id`, `nom`, `contenu`, `metatitle`, `metadescription`) VALUES
  (1, 'Accueil', '<h1>\r\n  Bienvenue !</h1>\r\n<p>\r\n Merci d&#39;utiliser Link To The Webf</p>\r\n<p>\r\n  Vous pouvez vous connecter &agrave; la console d&#39;administration<a href="admin666"><strong> ici</strong></a></p>\r\n<p>\r\n  Par d&eacute;faut votre login est votre <strong>adresse e-mail</strong> et le mot de passe : <strong>123123</strong><br />\r\n  <em>Pensez &agrave; le modifier d&egrave;s votre premi&egrave;re connection</em></p>\r\n<p>\r\n &nbsp;</p>\r\n<p>\r\n Pour plus de s&eacute;curit&eacute;s, nous vous conseillons de <strong>supprimer le dossier install</strong>.</p>\r\n<p>\r\n  &nbsp;</p>\r\n<p>\r\n N&#39;h&eacute;sitez pas &agrave; nous faire des retour sur contact@thomas-abadie.net</p>\r\n<p>\r\n  &nbsp;</p>\r\n<p>\r\n &nbsp;</p>\r\n<p>\r\n &nbsp;</p>\r\n<p>\r\n &nbsp;</p>\r\n', '', ''),
  (2, 'Qui sommes nous', '<p>\r\n Description &nbsp;...</p>\r\n', NULL, NULL) ;

INSERT INTO `__PREFIXrubriqueelements` (`id`, `ordre`, `contenutype_id`, `contenupage_id`, `graphelement_id`, `rubrique_id`) VALUES
  (1, 0, 1, 1, 11, 1),
  (2, 0, 1, 2, 12, 2),
  (3, 0, 3, 1, 14, 3) ;
...
INSERT INTO `__PREFIXrubriques` (`id`, `nom`, `img_btn`, `img_btn_actif`, `url`, `parent`, `metatitle`, `metadescription`, `metakeyword`, `created`, `modified`, `contenutype_id`, `contenupage_id`) VALUES
  ...
  (2, 'Qui sommes nous ?', '', '', '', 0, '', '', '', NOW(), NOW(), 1, NULL),
  (3, 'Contact', '', '', '', 0, '', '', '', NOW(), NOW(), 1, NULL) ;
