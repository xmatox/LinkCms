...
class ActualitesController extends ActualitesAppController {
	...
	function admin_install(){
		...
		$this->Contenutype->query("CREATE TABLE IF NOT EXISTS `".$prefix."actualiteelements` (
								  `id` int(11) NOT NULL AUTO_INCREMENT,
								  `date` date NOT NULL,
	...
	function admin_delete(){
		...
		$this->Contenutype->query("DROP TABLE `".$prefix."actualiteelements`"); 
		//Contenutype DELETE 
	...
	function admin_edit($id=null){
		$this->redirect(array('controller' => 'actualiteelements','action' => 'list',$id));
	}
