...
$foldermin = !empty($h['x-file-foldermin']) ? $h['x-file-foldermin'] : "0";
$widthmin = !empty($h['x-file-widthmin']) ? $h['x-file-widthmin'] : "0";
$heightmin = !empty($h['x-file-heightmin']) ? $h['x-file-heightmin'] : "0";
$foldermin2 = !empty($h['x-file-foldermin2']) ? $h['x-file-foldermin2'] : "0";
$widthmin2 = !empty($h['x-file-widthmin2']) ? $h['x-file-widthmin2'] : "0";
$heightmin2 = !empty($h['x-file-heightmin2']) ? $h['x-file-heightmin2'] : "0";
...
function creerMin($img,$chemin,$nom,$mlargeur=100,$mhauteur=100,$cadre){
	...
	if($mhauteur=="16"){
		@imagegif($miniature, $chemin."/favicon.gif");
		@imagegif($miniature, $chemin."/favicon.ico");
	}else{
		switch($type){
