/*
 *  Sudo Slider ver 1.0.6 - jQuery plugin 
 ...
 */
 ...
 1.0.6
 Fixed customLinks and first/last buttons fading out when continuous:true. (Thanks to Tim Doege for "finding" that one). 
	...
	$.fn.sudoSlider = function(options)
	{
		...
		else
		{
			...
			{	
				...
				if (optionsfade && obj.css("position") == "static") obj.css("position","relative");
