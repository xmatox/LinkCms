...
echo $this->Html->script("graph/editzone.js");
...
<div id="zonevisu2" data-value="<?php echo $graph["Graphelement"]["nom"]; ?>">
<div id="<?php echo $graph["Graphelement"]["nom"]; ?>" class="header">
		
	<?php
	echo $this->element('zone/'.$graph["Graphelement"]["nom"]);
	?>	</div>
</div>

<div id="zoneparam" style="height:auto;width:600px" data-value="ze_<?php echo $zel["Zoneelement"]["id"]; ?>">
