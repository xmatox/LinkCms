<div id="zp_elstyle" style="display:none;">
		...
		<div id="zp_cont_elstyle" class="zp_cont">
			...
			Bordure arrondi : <input type="text" id="zpe_borderradius1" title="Haut Gauche" style="width:40px" /> - <input type="text" id="zpe_borderradius2" title="Haut Droite" style="width:40px" /> - <input type="text" id="zpe_borderradius3" title="Bas Droite" style="width:40px" /> - <input type="text" id="zpe_borderradius4" title="Bas Gauche" style="width:40px" /><br/><br/>
			Espacement exterieur : <br/><input type="text" id="zpe_margin4" title="A Gauche" style="width:40px" /> - <input type="text" id="zpe_margin1" title="En Haut" style="width:40px" /> - <input type="text" id="zpe_margin3" title="En Bas" style="width:40px" /> - <input type="text" id="zpe_margin2" title="A Droite" style="width:40px" /><br/><br/>
			Espacement interrieur : <br/><input type="text" id="zpe_padding4" title="A Gauche" style="width:40px" /> - <input type="text" id="zpe_padding1" title="En Haut" style="width:40px" /> - <input type="text" id="zpe_padding3" title="En Bas" style="width:40px" /> - <input type="text" id="zpe_padding2" title="A Droite" style="width:40px" /><br/><br/>
